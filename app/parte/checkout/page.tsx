...
import { PARTO_CHECKOUT_CONFIG, PARTO_PIX_PRICE, PARTO_CARD_INSTALLMENTS } from '@/lib/checkout-config'
...
function useCountdown() {
  ...
  useEffect(() => {
    const key = 'parto_checkout_timer_end'
...
export default function PartoCheckoutPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.confirmed && data.billingType === 'CREDIT_CARD') {
        ...
        router.push(`/parte/checkout/sucesso?metodo=cartao&value=${currentPrice}`); return
      }
      if (data.billingType === 'PIX') {
        sessionStorage.setItem('pix_data', JSON.stringify({
          ...
          successUrl: '/parte/checkout/sucesso',
        }))
          ...
          <div className="bg-white border border-gray-200 rounded-2xl overflow-hidden shadow-sm">
            <form onSubmit={handleSubmit}>
              ...
              <div className="p-6 space-y-4">
                ...
                <div onClick={() => setAddEbookParto(v => !v)}
                  className="cursor-pointer rounded-xl border-2 p-4 transition-all select-none"
                  style={{ borderColor: addEbookParto ? '#f59e0b' : '#fde68a', background: addEbookParto ? '#fffbeb' : '#fffdf5' }}>
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-start justify-between gap-2 mb-1.5">
                        <p className="text-xs font-black uppercase tracking-wide" style={{ color: '#92400e' }}>✨ Oferta especial — adicione agora</p>
                      ...
                      <p className="text-xs leading-relaxed text-gray-500">
                        Plano de parto, parto humanizado, analgesia, fases do trabalho de parto e muito mais.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <a href="https://wa.me/5547989293040?text=Olá! Tenho uma dúvida sobre as aulas do Parto."
        ...
        <div className="order-2 flex flex-col gap-5">
          <div className="relative rounded-2xl overflow-hidden">
            <div className="relative h-56">
              <Image src="/pregnant-yoga.webp" alt="Aulas sobre o Parto" fill className="object-cover" />
              ...
              <div className="absolute bottom-4 left-4 right-4">
                <p className="text-white/60 text-sm uppercase tracking-widest mb-1">Aulas completas</p>
                <h1 className="text-white text-2xl font-black leading-tight">Preparação para o Parto</h1>
          ...
          <div className="bg-white border border-gray-100 rounded-2xl p-4 shadow-sm">
            ...
            <ul className="space-y-2.5">
              {PARTO_CHECKOUT_CONFIG.features.map((f, i) => (
