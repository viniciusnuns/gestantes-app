    ...
    <div className="min-h-screen" style={{ background: '#F3F0FF' }}>
      ...
      <section className="relative overflow-hidden py-14 md:py-20">
        ...
        <div className="absolute bottom-0 left-1/2 w-[400px] h-[400px] rounded-full opacity-20 -translate-x-1/2 translate-y-1/2"
          style={{ background: 'radial-gradient(circle, #9B7AB8 0%, transparent 70%)' }} />
      ...
      <section className="py-14 md:py-20" style={{ background: 'linear-gradient(135deg, #EDE9FF 0%, #F5EBF7 50%, #F3F0FF 100%)' }}>
        <div className="max-w-4xl mx-auto px-5">
          <div className="text-center mb-6 md:mb-10">
            <p className="text-xs font-bold uppercase tracking-widest mb-2" style={{ color: '#7B5A94' }}>Quem já fez os exercícios</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            {[
              ...
              <div key={t.name} className="rounded-2xl p-6 shadow-sm border"
                style={{ background: 'white', borderColor: '#DDD5F0' }}>
                <div className="flex gap-1 mb-4">
                  {[...Array(5)].map((_, i) => (
                    <Star key={i} size={14} style={{ color: '#F5C89A', fill: '#F5C89A' }} />
                  ))}
                </div>
                <p className="text-sm leading-relaxed mb-4" style={{ color: '#5C4C7C' }}>
                  &ldquo;{t.text}&rdquo;
                </p>
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <p className="text-xs font-semibold" style={{ color: '#2E1B4E' }}>{t.name}</p>
                    <p className="text-xs" style={{ color: '#A89BC9' }}>{t.detail}</p>
                  </div>
                </div>
              </div>
            ))}
      ...
      <section className="py-14 md:py-20 max-w-3xl mx-auto px-5">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold mb-3" style={{ color: '#2E1B4E' }}>
            Você já se pegou pensando...
          </h2>
          <p className="text-lg" style={{ color: '#7B5A94' }}>Isso é mais comum do que você imagina</p>
        </div>
        ...
        <div className="space-y-4">
          {[
            ...
            <div key={i} className="rounded-2xl px-6 py-5 border"
              style={{ background: 'rgba(255,255,255,0.8)', borderColor: '#DDD5F0' }}>
      ...
      <section className="py-14 md:py-20 relative overflow-hidden" style={{ background: 'linear-gradient(135deg, #EDE9FF 0%, #F5EBF7 100%)' }}>
        <div className="max-w-3xl mx-auto px-5 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-6" style={{ color: '#2E1B4E' }}>
            Não é frescura. É o seu corpo pedindo ajuda.
          </h2>
          <p className="text-lg leading-relaxed mb-6" style={{ color: '#6B5B8B' }}>
          ...
          <p className="text-lg leading-relaxed mb-10" style={{ color: '#6B5B8B' }}>
          ...
          <div className="inline-flex items-center gap-3 px-6 py-4 rounded-2xl border"
            ...
            <p className="text-sm font-semibold text-left" style={{ color: '#2E1B4E' }}>
      ...
      <section className="py-14 md:py-20 max-w-5xl mx-auto px-5 text-center">
        <h2 className="text-3xl md:text-4xl font-bold mb-4" style={{ color: '#2E1B4E' }}>
          Comece em menos de 1 minuto
        </h2>
        <p className="mb-16" style={{ color: '#6B5B8B' }}>Três passos para começar a se sentir melhor</p>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            { n: '1', title: 'Crie sua conta', desc: 'Cadastro rápido, acesso imediato a todas as sequências.', color: '#7B5A94' },
            { n: '2', title: 'Escolha sua sequência', desc: 'Identifique onde está a dor e acesse a sequência certa para você — lombar, pelve, pescoço ou baixo ventre.', color: '#C4A8D9' },
            { n: '3', title: 'Sinta o alívio', desc: 'Exercícios guiados pela Dra. Fabiana, seguros e eficazes. A maioria das gestantes sente alívio já na primeira sessão.', color: '#9B7AB8' },
          ].map((step) => (
            <div key={step.n} className="flex flex-col items-center">
              ...
              <h3 className="font-bold text-lg mb-2" style={{ color: '#2E1B4E' }}>{step.title}</h3>
              <p className="text-sm leading-relaxed" style={{ color: '#6B5B8B' }}>{step.desc}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="py-14 md:py-20" style={{ background: 'linear-gradient(135deg, #EDE9FF 0%, #F5EBF7 50%, #F3F0FF 100%)' }}>
        <div className="max-w-5xl mx-auto px-5">
          <div className="text-center mb-14">
            <p className="text-xs font-bold uppercase tracking-widest mb-3" style={{ color: '#7B5A94' }}>O que você recebe</p>
            <h2 className="text-3xl md:text-4xl font-bold mb-4" style={{ color: '#2E1B4E' }}>
              6 sequências para as dores mais comuns da gestação.
            </h2>
            <p className="max-w-2xl mx-auto text-lg" style={{ color: '#6B5B8B' }}>
            ...
            {[
              ...
              <div key={seq.num}
                ...
                style={{
                  ...
                  borderColor: seq.highlight ? '#C4A8D9' : '#DDD5F0',
                  boxShadow: seq.highlight ? '0 4px 24px rgba(123,90,148,0.12)' : 'none',
                }}>
                ...
                <div>
                  <p className="font-bold text-sm mb-1" style={{ color: '#2E1B4E' }}>{seq.title}</p>
                  <p className="text-sm leading-relaxed" style={{ color: '#6B5B8B' }}>{seq.desc}</p>
                </div>
              </div>
            ))}
          </div>
          ...
          <div className="mt-6 rounded-2xl p-5 border-2 shadow-sm flex items-start gap-4"
            ...
            <div>
              ...
              <p className="text-sm leading-relaxed" style={{ color: '#6B5B8B' }}>
      ...
      <section className="py-14 md:py-20 max-w-5xl mx-auto px-5">
        <div className="text-center mb-14">
          <p className="text-xs font-bold uppercase tracking-widest mb-3" style={{ color: '#7B5A94' }}>Para quem é</p>
          <h2 className="text-3xl md:text-4xl font-bold mb-4" style={{ color: '#2E1B4E' }}>
            ...
            <div className="space-y-3">
              {[
                ...
                <div key={item} className="flex items-start gap-3">
                  ...
                  <p className="text-sm leading-relaxed" style={{ color: '#5C4C7C' }}>{item}</p>
                </div>
              ))}
            </div>
          </div>

          <div className="rounded-2xl p-7 border" style={{ background: 'rgba(255,255,255,0.6)', borderColor: '#DDD5F0' }}>
      ...
      <section className="py-14 md:py-20" style={{ background: 'linear-gradient(135deg, #EDE9FF 0%, #F5EBF7 100%)' }}>
        <div className="max-w-2xl mx-auto px-5 text-center">
          <p className="text-xs font-bold uppercase tracking-widest mb-3" style={{ color: '#7B5A94' }}>Antes de ver o preço</p>
          <h2 className="text-3xl md:text-4xl font-bold mb-4" style={{ color: '#2E1B4E' }}>
            Veja o que você está recebendo
          </h2>
          <p className="text-lg mb-12" style={{ color: '#6B5B8B' }}>
          ...
          <div className="space-y-3 mb-8">
            {[
              ...
              { item: 'Revisão ilimitada — assista quando precisar', value: 'sem preço' },
            ].map((row) => (
              <div key={row.item} className="flex items-center justify-between px-5 py-3.5 rounded-xl border"
                style={{ background: 'white', borderColor: '#DDD5F0' }}>
                <span className="text-sm text-left" style={{ color: '#5C4C7C' }}>{row.item}</span>
                <span className="text-sm font-semibold line-through ml-4 flex-shrink-0" style={{ color: '#A89BC9' }}>{row.value}</span>
              </div>
            ))}
          </div>

          <div className="rounded-2xl p-6 border-2" style={{ background: 'white', borderColor: '#C4A8D9' }}>
            <p className="text-sm mb-3" style={{ color: '#6B5B8B' }}>Se vendido separado: <span className="line-through">R$ 380+</span></p>
            <p className="text-sm font-semibold mb-1" style={{ color: '#7B5A94' }}>Seu investimento</p>
            <p className="text-4xl font-bold mb-1" style={{ color: '#2E1B4E' }}>12x de R$ 6,70</p>
            <p className="text-sm" style={{ color: '#A89BC9' }}>ou <strong style={{ color: '#5C4C7C' }}>R$ 67</strong> à vista no PIX</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-14 md:py-20" style={{ background: '#F3F0FF' }}>
        <div className="max-w-md mx-auto px-5 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-3" style={{ color: '#2E1B4E' }}>Acesso completo, pagamento único</h2>
          <p className="mb-10" style={{ color: '#6B5B8B' }}>Acesso imediato. Revise as sequências quantas vezes precisar.</p>

          <div className="relative rounded-3xl p-8 shadow-xl border-2 bg-white" style={{ borderColor: '#C4A8D9' }}>
            <p className="text-sm font-semibold mb-1" style={{ color: '#7B5A94' }}>12 parcelas de</p>
            <div className="mb-1">
              <span className="text-6xl font-bold" style={{ color: '#2E1B4E' }}>R$&nbsp;6,70</span>
            </div>
            <p className="text-sm mb-1" style={{ color: '#A89BC9' }}>ou <strong style={{ color: '#2E1B4E' }}>R$ 67</strong> à vista no PIX</p>
            <p className="text-xs mb-8" style={{ color: '#A89BC9' }}>7 dias de garantia</p>
            ...
            <div className="space-y-3 mb-8 text-left">
              {[
                ...
                <div key={label} className="flex items-center gap-3">
                  ...
                  <span className="text-sm font-medium" style={{ color: '#5C4C7C' }}>{label}</span>
                </div>
              ))}
            </div>
            ...
            <p className="text-xs mt-4" style={{ color: '#A89BC9' }}>
      ...
      <section className="py-14 md:py-20" style={{ background: 'linear-gradient(135deg, #2E1B4E 0%, #5C3A6B 100%)' }}>
        <div className="max-w-3xl mx-auto px-5 text-center">
          <p className="text-xs font-bold uppercase tracking-widest mb-4" style={{ color: '#C4A8D9' }}>Pense bem</p>
          ...
          <Link
            ...
            style={{ background: 'linear-gradient(135deg, #7B5A94 0%, #C4A8D9 100%)', color: 'white' }}
          >
            Quero aliviar minhas dores agora →
          </Link>
        </div>
        ...
        <div className="max-w-5xl mx-auto px-5">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div className="flex justify-center">
              <div className="relative">
                <div className="absolute -inset-3 rounded-[2.5rem] rotate-2"
                  style={{ background: 'linear-gradient(135deg, #7B5A94, #C4A8D9)', opacity: 0.4 }} />
                ...
                <div className="absolute -bottom-4 -right-4 rounded-2xl px-4 py-3 shadow-xl"
                  ...
                  <p className="font-bold text-sm" style={{ color: '#2E1B4E' }}>Dra. Fabiana Pinheiro da Silva</p>
                  <p className="text-xs mt-0.5" style={{ color: '#7B5A94' }}>Fisioterapeuta · CREFITO 211253-F</p>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <p className="text-lg leading-relaxed mb-4" style={{ color: '#6B5B8B' }}>
              ...
              <p className="text-lg leading-relaxed mb-8" style={{ color: '#6B5B8B' }}>
                Criou as Sequências para Alívio de Dores para que você tenha a mesma qualidade de orientação das pacientes do consultório dela — com <strong style={{ color: '#7B5A94' }}>segurança, clareza e resultado</strong>.
              </p>
              <div className="space-y-3">
                {[
                  ...
                  <div key={item} className="flex items-center gap-3">
                    ...
                    <span className="font-medium" style={{ color: '#5C4C7C' }}>{item}</span>
                  </div>
                ))}
              </div>
            </div>
      ...
      <section className="py-14 md:py-20 relative overflow-hidden" style={{ background: 'linear-gradient(135deg, #7B5A94 0%, #C4A8D9 60%, #9B7AB8 100%)' }}>
        ...
        <div className="relative max-w-3xl mx-auto px-5 text-center">
          ...
          <Link
            ...
            style={{ background: 'white', color: '#7B5A94' }}
          >
            Quero aliviar minhas dores agora →
          </Link>
      ...
      <section className="py-14 md:py-20" style={{ background: 'linear-gradient(135deg, #EDE9FF 0%, #F5EBF7 50%, #F3F0FF 100%)' }}>
        <div className="max-w-2xl mx-auto px-5">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4" style={{ color: '#2E1B4E' }}>Perguntas frequentes</h2>
          </div>
          <DoresFAQ />
        </div>
      </section>
      ...
      <section className="py-12 max-w-2xl mx-auto px-5 text-center">
        <div className="bg-white rounded-3xl p-8 shadow-sm border border-purple-100 flex flex-col items-center gap-4">
          <div className="w-16 h-16 rounded-full bg-emerald-100 flex items-center justify-center">
            <Shield size={28} className="text-emerald-600" />
          </div>
          <h3 className="text-xl font-black" style={{ color: '#2E1B4E' }}>Garantia de 7 dias</h3>
      ...
      {/* FOOTER */}
      <footer className="py-8 border-t border-white/40" style={{ background: '#F3F0FF' }}>
        <div className="max-w-6xl mx-auto px-5 flex flex-col md:flex-row items-center justify-between gap-4 text-sm" style={{ color: '#A89BC9' }}>
          <span className="font-semibold" style={{ color: '#7B5A94' }}>Gestar em Movimento</span>
          <div className="flex items-center gap-6">
            <Link href="/terms" className="hover:text-purple-600 transition-colors">Termos de uso</Link>
            <Link href="/privacy" className="hover:text-purple-600 transition-colors">Privacidade</Link>
            <Link href="/login" className="hover:text-purple-600 transition-colors">Entrar</Link>
            <Link href="/dores/checkout" className="hover:text-purple-600 transition-colors">Comprar sequências</Link>
          </div>
        </div>
      </footer>
